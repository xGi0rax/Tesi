...
\newcommand{\usecaseactors}[1]{\textbf{\\Attori:} #1}
\newcommand{\usecasedesc}[1]{\textbf{\\Descrizione:} #1}
\newcommand{\usecasepre}[1]{\textbf{\\Precondizioni:} #1}
\newcommand{\usecaseprin}[1]{\textbf{\\Scenario principale:} #1}
...
\newenvironment{risk}[1]{
    ...
    \par\vspace{1em}\noindent % 1. Spazio verticale sopra il titolo
    \textbf{\arabic{riskcounter}. #1}\par\nopagebreak % display the title before the content of the environment is displayed
    \begingroup\leftskip=2em\parindent=0pt % 2. Aggiunge un rientro a sinistra per tutto il contenuto del rischio
}{
    \par\endgroup
}
\newcommand{\riskname}{Rischio}
\newcommand{\riskdescription}[1]{\textbf{Descrizione:} #1.\par\nopagebreak\smallskip}
\newcommand{\riskprobability}[1]{\textbf{Probabilità:} #1.\par\nopagebreak\smallskip}
\newcommand{\riskimpact}[1]{\textbf{Impatto:} #1.\par\nopagebreak\smallskip}

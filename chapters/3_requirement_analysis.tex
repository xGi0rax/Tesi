...
\begin{figure}[H]
    \vspace{2em}
    \centering
    \includegraphics[alt={Scenario di inserimento multiplo in una nota spesa}, width=0.90\columnwidth]{img/usecase/UCMultiplo.jpg}
...
\begin{center}
    ...
    RVO-7 & Per il servizio di estrazione dati dalle immagini deve essere interrogata l'API di Azure Content Understanding. & - \\
    \hline
    \hiderowcolors

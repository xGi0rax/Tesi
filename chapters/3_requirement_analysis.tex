...
\noindent Gli attori rappresentano le entità (utenti fisici o sistemi esterni) che interagiscono in modo diretto con l'applicazione. Per il progetto sviluppato, sono stati individuati i seguenti attori principali:
\begin{itemize}
    \item \textbf{Dipendente:} rappresenta un dipendente dell'azienda che ha già effettuato l'accesso all'applicazione mobile tramite le proprie credenziali. Esso interagisce con la nuova sezione per consultare lo storico delle proprie spese inserite e per inserire, allegando evenutali fotografie, nuove note spesa da inoltrare al sistema.
    
    \item \textbf{Azure Content Understanding (Sistema AI):} sistema esterno basato su intelligenza artificiale, interrogato dall'applicazione per l'estrazione automatica dei dati dalle fotografie degli scontrini, al fine di semplificare e velocizzare la compliazione della nota spesa da parte del dipendente.
\end{itemize}
...
I diagrammi dei casi d'uso sono diagrammi di tipo dedicati alla descrizione delle funzioni o servizi offerti da un sistema, così come sono percepiti e utilizzati dagli attori che interagiscono col sistema stesso.
